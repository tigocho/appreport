<div class="iq-card"> 
    ...
    <div class="iq-card-header d-flex justify-content-between">
        ...
        <div class="iq-card-header-toolbar d-flex align-items-center">
            <button type="button" onclick="modal_typeincident_create();"  style="float: right;" class="btn btn-success">Registro de tipo incidencia</button>
        </div>
    </div>
    ...
    <div class="iq-card-body">
        ...
        <div class="modal fade" id="typeincident_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edición tipo de incidencia</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
