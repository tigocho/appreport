	...
	<div id="sidebar-scrollbar">
		<nav class="iq-sidebar-menu">
			<ul id="iq-sidebar-toggle" class="iq-menu">
				...
				<?php if ($this->session->userdata('rol_id') > 0 and $this->session->userdata('rol_id') < 4) { ?>
					<li>
						<a href="<?php echo base_url(); ?>cmi/index" class="iq-waves-effect"><i class="ri-bar-chart-box-fill"></i><span>CMI</span></a>
					</li>
				<?php } ?>
				<li>
