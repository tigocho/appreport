    ...
    <tbody>
        <?php foreach ($registros as $value => $registro) { ?>
          <tr>
            ...
            <td class="text-left"><?php echo "<input type='number' maxlength='3' id='CodigoEspecialidad-".$value."' name='CodigoEspecialidad[]' value=".$registro[1]." required>" ?></td>
            ...
            <td class="text-left"><?php echo "<input type='text' class='validacion-datos-cargados' id='Validacion-".$value."' name='Validacion[]' value='".$registro[8]."'required>" ?></td>
          </tr>
        <?php } ?>
    </tbody>
  </table>
