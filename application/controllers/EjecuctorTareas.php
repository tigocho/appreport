<?php
    class ejecuctorTareas extends CI_Controller {
        ...
        public function notifications()
        {
           ...
           $correo_usuario = $data->usu_correo;
           $correo_copia= $data->jefe_correo;     
           $asunto = 'Hola '.ucwords($data->usu_nom).'  - Appreport';
           $body =  '<b>Cordial Saludo: '.ucwords($data->usu_nom)." ".ucwords($data->usu_ape).'</b>           
               ...
               **********************Mensaje Generado Automáticamente**********************
               ...
               $resp = enviar_correo($correo_usuario,$asunto,$body,$correo_copia);
           }
