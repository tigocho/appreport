<?php
    class Novelty_model extends CI_Model {
        ...
        // funcion que contiene la consulta que trae las novedades abiertas 
        ...
        // funcion que contiene la consulta que trae las novedades cerradas
        ...
        // funcion que contiene el sql que guarda la informacion de la novedad 
        public function saveNovelty($data)
        {
            return $this->db->insert('ir_novedad',$data);
        }

        // funcion que contiene la consulta que trae una novedad especifica para la vista de editar
        public function get_edit_novelty($nove_id)
        { 
        $sql = "SELECT n.nove_id,n.nove_fecha,c.col_login_num,c.col_nom,s.seccion_nom,n.nove_obser_descripcion
        ,ti.tip_obser_nom,n.nove_hora_ini,n.nove_hora_fin,n.nove_tiem_total
        ,cg.cate_nom,t.tip_inci_nom,e.est_des,n.seccion_id_fk,n.col_id_fk,n.tip_inci_id_fk,n.est_id_fk
        ...
        // funcion que contiene el sql que edita la informacion de de la novedad 
        ...
        // funcion que contiene el sql que cambia el tipo de estado "elimina" la informacion de una novedad  especifica 
