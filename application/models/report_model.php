    ...
    class Report_model extends CI_Model {
       // inicio conexion base de datos 
        ...
        public function get_novelty($inicio,$fin)
            {
            $sql = "SELECT n.nove_id,n.nove_fecha,c.col_login_num,c.col_nom,s.seccion_nom,n.nove_hora_ini,n.nove_hora_fin,n.nove_tiem_total,cg.cate_nom,t.tip_inci_nom,e.est_des
